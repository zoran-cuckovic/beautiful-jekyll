...
But, why should we drop all the benefits of georeferenced environment and revert to software which does not handle geographical data? It is not that difficult to simulate natural light, provided that we do not expect the same quality as in dedicated 3D doftware. 
